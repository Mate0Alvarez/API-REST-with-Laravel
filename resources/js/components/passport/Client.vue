...
<template>
    <div>
        ...
        <!-- Create Client Modal -->
        <div class="modal fade" id="modal-create-client" tabindex="-1" role="dialog" data-toggle="modal">
        ...
        <div class="modal fade" id="modal-client-secret" tabindex="-1" role="dialog">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>
                            Here is your new client secret. This is the only
                            time it will be shown so don't lose it! You may now
                            use this secret to make API requests.
                        </p>
...
export default {
    ...
    methods: {
        ...
        showCreateClientForm() {
            const myModal = new Modal(document.getElementById('modal-create-client'), {
                keyboard: false
            })
            myModal.show();
        },
        ...
        edit(client) {
            ...
            const myModal = new Modal(document.getElementById('modal-edit-client'), {
                keyboard: false
            })
            myModal.show();
        },
        ...
        persistClient(method, uri, form, modal) {
            ...
            axios[method](uri, form)
                .then((response) => {
                    ...
                    const myModal = Modal.getOrCreateInstance(document.getElementById(modal))
                    myModal.hide();
        ...
        showClientSecret(clientSecret) {
            ...
            const myModal = new Modal(document.getElementById('modal-client-secret'), {
                keyboard: false
            })
            myModal.show();
        },
