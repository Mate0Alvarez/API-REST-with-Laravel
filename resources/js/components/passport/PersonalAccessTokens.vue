...
export default {
    ...
    methods: {
         ...
         */
        showCreateTokenForm() {
            const createTokenModal = new Modal(document.getElementById('modal-create-token'), {
                keyboard: false
            })
        ...
        showAccessToken(accessToken) {
            const createTokenModal = Modal.getOrCreateInstance(document.getElementById('modal-create-token'));
            createTokenModal.hide();

            this.accessToken = accessToken;

            const accessTokenModal = new Modal(document.getElementById('modal-access-token'), {
                keyboard: false
            })
